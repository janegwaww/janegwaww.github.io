...
到这里基础功能讲完了，后面就要做一些优化和扩展了，方便我们对于更复杂需求和更多场景下的使用。首先我们对上面的代码做一些优化，使用函数式编程，好处就是对于复杂场景也能用简单易懂的代码表达清楚。只更改JS代码，其他代码保持不变。
...
#+begin_src js
  ...
  function isValid(value) {
    const validObj = {v:value, valid:false, err:""};
    ...
    return  pipe(notEmpty, tooShort, isFormat)(validObj)
  }
